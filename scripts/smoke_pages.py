...
def build_checks():
    ...
    checks = [
        ...
        # Разделы-витрины: у каждого свой адрес, и сломать их можно
        # независимо от каталога.
        ("/new/", "раздел: новинки"),
        ("/popular/", "раздел: популярное"),
        ("/top/", "раздел: топ"),
        ("/premieres/", "раздел: премьеры"),
        ("/franchises/", "франшизы"),
        ("/search/?q=фильм", "поиск: страница"),
        ("/api/v1/titles/search/?q=фильм", "API: подсказки поиска"),
